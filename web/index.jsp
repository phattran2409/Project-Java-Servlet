<%-- 
    Document   : index
    Created on : Jun 19, 2024, 10:14:31 PM
    Author     : ADMIN
--%>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
                ...
                <div class="navbar align-self-center d-flex">
                    <div class="d-lg-none flex-sm-fill mt-3 mb-4 col-7 col-sm-auto pr-3 justify-content-center align-content-center">
                    ...
                    <c:if test="${User == null}">
                    <a href="login.jsp" class="btn btn-success mx-3 text-light text-decoration-none text" style="width:100px ; height: auto; font-weight: 900;" > 
                        <span>Login</span>
                    </a>
                    </c:if>
                </div>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/img/Sneaker/JD_001.jpg" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Sneaker</h5>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/img/Running/RN_001.jpg" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Running</h2>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/img/Football/FB_001.jpg" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">FootBall</h2>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
        </div>
    </section>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="./assets/img/Sneaker/JD_005.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="./assets/img/Running/RN_006.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="./assets/img/Football/FB_007.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li>
                            ...
                            <a class="text-decoration-none" href="mailto:info@company.com">ShoesStore@company.com</a>
                        </li>
                    </ul>
                </div>
