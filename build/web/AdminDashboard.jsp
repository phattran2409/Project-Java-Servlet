                        ...
                        <header>
                            ...
                            <nav id="sidebarMenu" class="collapse  sidebar  bg-white hide">
                                <div class="position-sticky">
                                    <div class="list-group list-group-flush mx-3 mt-4">
                                        <a href="#" class="list-group-item list-group-item-action  ripple bg-gradient-primary rounded-pill"
                                        ...
                                        <a href="LoadStaff" class="list-group-item list-group-item-action py-2 ripple"
                                            aria-current="true">
                            ...
                            <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
                                ...
                                <div class="container-fluid">
                                    <!-- Toggle button -->
                                    <button id="toggle-navbar" class=" mr-auto btn btn-outline-primary">
                                ...
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Insert A New Product
                                            </h1>
                                                ...
                                                <div class="form-insert">
                                                    <div class="">
                                                        ...
                                                        <select name="Cate_ID" id="">
                                                            <% CategoryDAO CateDao=new CategoryDAO(); List<Category>
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-6 d-flex flex-column">
                                                            <label class="label-input-insert" for="">Product ID</label>
                                                            <input type="text" name="P_ID" id=""
                                                                class="form-control rounded-pill">
                                                        </div>
                                                        <div class="col-6 d-flex flex-column">
                                                            <label class="label-input-insert" for="">Prdoduct
                                                                Name</label>
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-6 d-flex flex-column">
                                                            <label class="label-input-insert" for="">Image
                                                                Direction</label>
                                                            <input type="text" name="image"
                                                                class="form-control rounded-pill">
                                                        </div>
                                                        <div class="col-6 d-flex flex-column">
                                                            <label class="label-input-insert" for="">Brand</label>
                                                        ...
                                                        <div class="row mt-4">
                                                            <div class="col-3">
                                                                <label class="label-input-insert" for="">Price</label>
                                                                <input type="text" name="Price"
                                                                    class="form-control rounded-pill">
                                                            </div>
                                                            <div class="col-3">
                                                                <label class="label-input-insert"
                                                                    for="">Discount</label>
                                                                <input type="text" name="Discount"
                                                                    class="form-control rounded-pill" pattern="[/d]"
                                                                    title="Use Number  0 -> 9">
                                                            </div>
                                                            <div class="col-3">
                                                                <label class="label-input-insert"
                                                                    for="">Quantity</label>
                                                            ...
                                                            <div class="col-3">
                                                                <label class="label-input-insert" for="">Show</label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="action"
                                                value="Insert New Product">Saves
                                                Change</button>
                                        </div>
                                        </form>
                                    </div>
                                        ...
                                        <c:forEach var="P" items="${list}">
                                            ...
                                            <tr class="product">
                                                <form method="POST" action="MainController">
                                                    <td scope="row">
                                                        <input type="text" name="P_ID" value="${P.getProductID()}"
                                                            readonly>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="P_Name" value="${P.getProductName()}">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" name="Brand" id="" value="${P.getBrand()}">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="number" name="show" value="${P.getShow()}">
                                                    </td>
                                                    <td>
                                                        <button type="submit" name="action" value="update product"
                                                            class="btn btn-outline-primary">
                                                            <i class="fa fa-pencil-alt "></i>
                                                        </button>
                                                    </td>
                                                    <td>
                                                        <button type="submit" name="action" value="remove product"
